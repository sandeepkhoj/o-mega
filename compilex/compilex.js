...
exports.runCppWithInput = function ( envData , code , input ,  fn ) {
	if(exports.stats)
		cppModule.stats = true;
	cppModule.runCppWithInput(envData , code , input , fn );
}
...
exports.runJavaWithInput = function ( envData , code , input ,  fn ){
	if(exports.stats)
		javaModule.stats = true;
	javaModule.runJavaWithInput( envData , code , input ,  fn );
}
